...
class FairseqEncoderDecoderModel(BaseFairseqModel):
    ...
    def forward(self, tgt_tokens, src_tokens, src_lengths, prev_output_tokens, **kwargs):
        ...
        # Randomly select initial latency
        new_times = torch.randint(1,src_tokens.size(1)+1,(1,)).cuda(device=src_tokens.device).item()

        decoder_out,first_loss,last_loss = self.decoder(prev_output_tokens, encoder_out=encoder_out, tgt_tokens=tgt_tokens, src_tokens=src_tokens,new_times=new_times, **kwargs)
        return decoder_out, first_loss, last_loss
